                ...
                <Row>
                  ...
                  <Col span="6">
                    {getFieldDecorator('placeFrom_'+k)(
                         ...
                         showArrow={false}
                         filterOption={false}  
                        //  onSearch={(value=>{console.log("seacrch",value);})} 
                  ...
                  <Col span="1" style={{marginRight:'-18px'}} className="place-line">
                ...
                <Row>
                  ...
                  <Col span="6" style={{marginRight:'18px'}}>
                    {getFieldDecorator('dateFrom_'+k)(
                      <DatePicker size="small" style={{width:'200px'}} placeholder="出發日期"/>
                    )}
                  </Col>
                  <Col span="5">
                    {getFieldDecorator('timeFrom1_'+k)(
                      <TimePicker style={{width:'200px'}} format={format} minuteStep={30} className="time" size="small" placeholder="起飛時間區間: 開始"/>
                    )}
                  </Col>
