...
class AddNewPeople extends Component {
  ...
  render(){
    const { width, handleAddShow, handleAdd, form, showModal, handleHiddenModal,personData } = this.props;
    return(
      <div>
       <Button
        type="primary"
...
const mapStateToProps = ( state ) => {
  const { baseInfo, showModal, isEdit } = state.adminMaintainReducer2.homepageNewsManagementReducer;
